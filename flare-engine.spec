...
Version  : 1.13
Release  : 5
URL      : https://github.com/flareteam/flare-engine/archive/v1.13/flare-engine-1.13.tar.gz
Source0  : https://github.com/flareteam/flare-engine/archive/v1.13/flare-engine-1.13.tar.gz
...
%prep
%setup -q -n flare-engine-1.13
cd %{_builddir}/flare-engine-1.13
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1644348984
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/flare-engine-1.13/COPYING %{buildroot}/usr/share/package-licenses/flare-engine/8624bcdae55baeef00cd11d5dfcfa60f68710a02
cp %{_builddir}/flare-engine-1.13/cmake/Copyright.txt %{buildroot}/usr/share/package-licenses/flare-engine/8137c6d95383060d26f828eeea5ff086578c639a
pushd clr-build-avx2
%make_install_v3  || :
popd
pushd clr-build-avx512
