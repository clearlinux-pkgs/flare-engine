...
Version  : 1.12
Release  : 4
URL      : https://github.com/flareteam/flare-engine/archive/v1.12/flare-engine-1.12.tar.gz
Source0  : https://github.com/flareteam/flare-engine/archive/v1.12/flare-engine-1.12.tar.gz
...
%prep
%setup -q -n flare-engine-1.12
cd %{_builddir}/flare-engine-1.12
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1627943918
mkdir -p clr-build
pushd clr-build
...
export RANLIB=gcc-ranlib
export NM=gcc-nm
export CFLAGS="$CFLAGS -O3 -ffat-lto-objects -flto=auto -march=skylake-avx512 "
export FCFLAGS="$FFLAGS -O3 -ffat-lto-objects -flto=auto -march=skylake-avx512 "
export FFLAGS="$FFLAGS -O3 -ffat-lto-objects -flto=auto -march=skylake-avx512 "
export CXXFLAGS="$CXXFLAGS -O3 -ffat-lto-objects -flto=auto -march=skylake-avx512 "
...
cp %{_builddir}/flare-engine-1.12/COPYING %{buildroot}/usr/share/package-licenses/flare-engine/8624bcdae55baeef00cd11d5dfcfa60f68710a02
cp %{_builddir}/flare-engine-1.12/cmake/Copyright.txt %{buildroot}/usr/share/package-licenses/flare-engine/8137c6d95383060d26f828eeea5ff086578c639a
pushd clr-build-avx512
%make_install_avx512  || :
popd
pushd clr-build
...
%defattr(-,root,root,-)
/usr/bin/flare
/usr/bin/haswell/avx512_1/flare
