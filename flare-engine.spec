...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1701955665
mkdir -p clr-build
pushd clr-build
...
CLEAR_INTERMEDIATE_CXXFLAGS="$CLEAR_INTERMEDIATE_CXXFLAGS -O3 -Ofast -falign-functions=32 -ffat-lto-objects -flto=auto -fno-semantic-interposition "
